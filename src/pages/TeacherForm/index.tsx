...
function TeacherForm() {
    ...
    return (
        <div id="page-teacher-form" className="container">
            <PageHeader
                title="Que incrivel que você vai dar aulas."
                        ...
                        {scheduleItens.map((scheduleItem, index) => {
                            return (
                                <div key={scheduleItem.week_day} className="schedule-item">
                                    ...
                                    />
                                    <Input name="from" label="Das" type="time" value={scheduleItem.from} onChange={(e) => setScheduleItensValue(index, 'from', e.target.value)}/>
                                    <Input name="to" label="Até" type="time" value={scheduleItem.to} onChange={(e) => setScheduleItensValue(index, 'to', e.target.value)}/>
                                </div>
                            )
                        })}
                    </fieldset>
